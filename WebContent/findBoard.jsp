<%@page import="kongs.util.FindPageAction"%>
...
<body>
	<div id="mainMenu">
		<div class="container">
			...
			<ul id="menu">				
				...
				<li><a href="<c:url value="/"/>front?command=community">커뮤니티</a></li>
	...
	<div id="com_post_board">
		<div class="container">
			<!-- 게시판 제목 -->
			<p class="title">
				<img src="img/CompetitionBoard/con_title_logo.gif"> 팀원구하기
			</p>
			<div id="tableView">
				<form action="" method="get" onsubmit="">
					<table>
						...
						<!-- 게시판 내용 -->
						<jsp:useBean id="db" class="kongs.dao.BoardDAOImpl"/>
						<%
							String keyField="", keyWord="";
						
							//검색 일 경우에 넘어오는 keyField, keyWord 받기
							...
							List<Board> list = db.getBoardList(pageNum , keyField , keyWord, "findboard");
				...
				<!-- 페이징 -->
				<div id="boardPage"><%=FindPageAction.pageNumber()%></div>
				<div id="boardSearchView">
					<form action="<c:url value="/"/>front?command=find" method="post">
