   ...
   public static String pageNumber(){
	   ...
	   //2. [이전] 만들기
	    ...
	    if( (startPage - blockCount) >  0 ){
	       str="<a href='findBoard.jsp?pageNum="+(startPage-1)+"&keyField="+keyField+"&keyWord="+keyWord+"'>◀이전 </a>&nbsp;&nbsp;" ;
	    }
	   ...
	   //4.[다음]  만들기
	    ...
	    if( (startPage + blockCount) <= pageCount ){
	       str+="<a href='findBoard.jsp?pageNum="+(startPage+blockCount)+"&keyField="+keyField+"&keyWord="+keyWord+"'> ▶다음 </a>" ;
	    }   
